...
export default class Results extends React.Component {
    ...
    render() {
        let dynamicHeight = '100px'
        if (this.state.clicked === true) dynamicHeight = '300px'
        return (
            <div style={{innerWidth: '300px', height: dynamicHeight, border: 'solid 1px black'}} onClick={() => this.clicked()}>
                {searchJson.results[0].name}
            </div>
        );
    }
}
